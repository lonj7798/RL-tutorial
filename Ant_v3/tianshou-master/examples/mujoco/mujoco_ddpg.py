...
def test_ddpg(args=get_args()):
    ...
    f = open("/home/jaewon/MyWork/RL-tutorial/Ant_v3/tianshou-master/examples/mujoco/history_ddpg/Ant-v3/history_ddpg.txt", 'a')
    f.write(f'{result["rews"].mean()}, {result["lens"].mean()}\n')
    f.close()
